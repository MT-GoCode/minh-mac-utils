...
public enum MarkerIO {
    ...
    @discardableResult
    public static func append(_ path: String, line: String?, mode: mode_t = 0o644) -> Bool {
    ...
    @discardableResult
    public static func append(_ path: String, lines: [String], mode: mode_t = 0o644) -> Bool {
    ...
    public static func consumeLines(_ path: String, enforcedUID: uid_t) -> [String]? {
    ...
    public static func consumeLast(_ path: String, enforcedUID: uid_t) -> String? {
    ...
    public static func consumeFlag(_ path: String, enforcedUID: uid_t) -> Bool {
